...
class ReviewViewSet(viewsets.ModelViewSet):
    """
    Получить список всех отзывов. Доступ: без токена.
    Создать новый отзыв. Доступ: аутентифицированные пользователи.
    Получить отзыв по id. Доступ: без токена.
    Частично обновить отзыв по id. Доступ: автор отзыва, модератор или администратор.
    Удалить отзыв по id. Доступ: автор отзыва, модератор или администратор.
    """
...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    Создать новый комментарий для отзыва. Доступ: аутентифицированные пользователи.
    Получить комментарий для отзыва по id. Доступ: без токена.
    Частично обновить комментарий к отзыву по id. Доступ: автор отзыва, модератор или администратор.
    Удалить комментрий к отзыву по id. Доступ: автор отзыва, модератор или администратор.
    """
